...
def main(parse):
    raw_data = YouTube.api.api_manager(parse)
    final_api_data = YouTube.filters.filter_manager(raw_data, parse)
    YouTube.writer.write_file(final_api_data, parse)
    return
...
if __name__ == "__main__":
    ...
    parser.add_argument('--task', '-t',
                        ...
                        nargs=1,
                        default='trends')
    parser.add_argument('--category', '-ct',
